...
insert into Contact (address_id, age, firstname, lastname, id) values (-3,31,'Mickey', 'Mouse', nextval('hibernate_sequence'));
insert into Contact (address_id, age, firstname, lastname, id) values (-3,25,'Minnie', 'Mouse', nextval('hibernate_sequence'));
insert into Contact (address_id, age, firstname, lastname, id) values (-3,32,'Donald', 'Duck', nextval('hibernate_sequence'));
